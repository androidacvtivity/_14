...
const validatedRowCodes = new Set();
...
// Function to set up real-time validation for new input
function setupRealTimeValidation() {
    $("input[data-col='1']").on("input", function () {
        ...
        if (validatedRowCodes.has(`${rowID}-${value}`)) {
            return;
        }

        // Mark the code as validated for this row
        validatedRowCodes.add(`${rowID}-${value}`);
